if (pregunta.includes("capitan") || pregunta.includes("capitán") || pregunta.includes("capitana") || pregunta.includes("capitanes")) {("Los capitanes son Karina (MataFama) y Pedro (Team Black)... @" + usuario);}
    ...
    else if (pregunta.includes("salvo") || pregunta.includes("salvó") || pregunta.includes("salvaron") || pregunta.includes("salvada") || pregunta.includes("salvado") || pregunta.includes("salvados")) { ("Chama salvada por Prueba de salvación y Yuyuniz por voto de los líderes ... @" + usuario); }

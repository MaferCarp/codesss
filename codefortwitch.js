if (pregunta.includes("líder") || pregunta.includes("líderes") || pregunta.includes("lider") || pregunta.includes("lideres") || pregunta.includes("liderazgo")) {("El nuevo líder es !iñigo. "); }   // quien/es, cual/es
    ...
    else if (pregunta.includes("qui") && pregunta.includes("eliminar") || pregunta.includes("cu") && pregunta.includes("eliminar")  || pregunta.includes("eliminad") || pregunta.includes("abandon")) {("Abandonó la casa Yuyuniz con (86,30%) sobre Patricio (13,70%). "); }

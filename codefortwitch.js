if (pregunta.includes("líder") || pregunta.includes("líderes") || pregunta.includes("lider") || pregunta.includes("lideres") || pregunta.includes("liderazgo")) {("El nuevo líder es !iñigo. "+random); }  
    ...
    else if (pregunta.includes("qui") && pregunta.includes("eliminar") || pregunta.includes("cu") && pregunta.includes("eliminar")  || pregunta.includes("eliminad")) {("La eliminada fue Yuyuniz (86,30%) sobre Patricio (13,70%). "); }

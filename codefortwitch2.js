if (pregunta.includes("capítulo")||pregunta.includes("episodio") ||pregunta.includes("prime") ||pregunta.includes("transmisión") || pregunta.includes("reality")) {(" Gala de eliminación (Domingo)...Competencia semanal (Martes)...Gala de nominación (Miércoles)... Prueba de salvación (Jueves)...Espiando la casa: «La fiesta» (Viernes) " +'  '+ usuario);}

if (pregunta.includes("capítulo")||pregunta.includes("episodio") ||pregunta.includes("prime") ||pregunta.includes("transmisión") || pregunta.includes("reality") || pregunta.includes("gala")) {("Noche de reality (Domingo) ...  Gala de eliminación (Lunes)...Competencia semanal (Martes)...Gala de nominación (Miércoles)... Prueba de salvación (Jueves)...Espiando la casa: «La fiesta» (Viernes) " +'  '+ usuario);}
  else if (pregunta.includes("eliminación") || pregunta.includes("elimin") || pregunta.includes("gala")) {( usuario +" "+ "Gala de eliminación ... → Domingo(cambio de horario)... " );}
